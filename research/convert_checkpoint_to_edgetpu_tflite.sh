...
pipeline_config_path=/data/models/research/models/person/pipeline.config
train_dir=/data/models/research/models/person/train
ckpt_number=500000
output_dir=/data/models/research/models/person/export
